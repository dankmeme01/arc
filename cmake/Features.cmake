...
macro(arc_define_feature NAME DEFAULT_VAL HELP_STR)
    if (ARC_FEATURE_FULL)
        option(ARC_FEATURE_${NAME} "${HELP_STR}" ON)
    else()
...
arc_define_feature(TIME ON "Enable time driver")
arc_define_feature(NET OFF "Enable networking support")
arc_define_feature(SIGNAL OFF "Enable signal handling")

arc_define_feature(DEBUG OFF "Enable debug assertions")
arc_define_feature(TRACE OFF "Enable debug tracing")
